 ...
 * ```
 */
export function checkAlerts(state, quotes) {
 ...
 * ```
 */
export function formatAlertMessage(alert, quote) {
 ...
 * ```
 */
export function createAlert(state, symbol, targetPrice, direction, message = "") {
    const newAlert = {
        id: randomUUID(),
 ...
 * ```
 */
export function deleteAlert(state, alertId) {
    return {
        ...state,
